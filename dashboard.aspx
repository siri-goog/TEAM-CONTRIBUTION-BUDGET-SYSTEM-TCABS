...
<body id="page-top">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseConvPeer" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="#">Manage Peer Assessment</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseSupMeeting" class="collapse" aria-labelledby="headingUnit" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="buttons.html">Meeting Management</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="divStudent" runat="server">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTask" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="#">Submit Individual Task</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseMeeting" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Meeting Menu:</h6>
                            <a class="collapse-item" href="#">Supervisor Meeting</a>
                            <a class="collapse-item" href="#">Team Meeting</a>
                        </div>
                    </div>
                </li>
                <!-- Nav Item - Peer Assessment Menu -->
                <li class="nav-item">
                    ...
                    <div id="collapsePeer" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Peer Assessment Menu:</h6>
                            <a class="collapse-item" href="#">Submit Peer Assessment</a>
                        </div>
                    </div>
                </li>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Employee Name" SortExpression="empName">
                                                <ItemTemplate>
                                                    ...
                                                    CommandName="Select" Text="Select"  CommandArgument ='<%#Eval("ID_Emp")%>'>
                                                    </asp:LinkButton> -->
                                                    <asp:Label ID="lblUnit" runat="server" Text='<%# Bind("unitStr") %>' Width="200px"></asp:Label>
                                                    <asp:Label ID="lblYear" runat="server" Text='<%# Bind("offUnitYear") %>' Width="200px"></asp:Label>
                                                    <asp:Label ID="lblSem" runat="server" Text='<%# Bind("semStr") %>' Width="200px"></asp:Label>
                                                </ItemTemplate>
    ...
    <footer>
        <p>&copy; <%: DateTime.Now.Year %> - TCABS Application</p>
    </footer>
</body>
</html>
