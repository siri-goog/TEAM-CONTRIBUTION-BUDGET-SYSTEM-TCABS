                ...
                <tr>
                    <td colspan="3">
                        <table>
                            <tr><td colspan="3">&nbsp;</td></tr>
                            <tr>
                                <td align="right" width="47%">Title</td>
                            ...
                            <tr>
                                <td align="right" width="47%">Due date</td>
                                <td align="center" width="3%">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                Font-Size="8pt" CssClass="textbox"></asp:TextBox>
                                                <asp:ImageButton ID="IMbCal_Last" runat="server" ImageUrl="~/icons/icon_carlendar.gif"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">&nbsp;</td>
                                            <td>
                                                <asp:Calendar ID="cal_last" runat="server" BackColor="White"
                            ...
                            <tr>
                                <td colspan="3">&nbsp;
                                    ...
                                    <asp:GridView ID="gvAdd_Last" runat="server" AutoGenerateColumns="False" CssClass="GridViewBodyStyle">
                                        <Columns>
                                            <asp:BoundField DataField="StuID" HeaderText="Student ID" ReadOnly="True" />
                                            <asp:BoundField DataField="StuName" HeaderText="Name" ReadOnly="True" />
                                            <asp:BoundField DataField="stulevel" HeaderText="Level" ReadOnly="True" />
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td align="left" width="50%">
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" Width="171px" visible="false"
                                        Font-Size="8pt" CssClass="textbox"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" width="50%">
                                    <asp:TextBox ID="txtDetails_Present" runat="server" Width="300px" visible="false"
                                        Font-Size="8pt" CssClass="textbox" TextMode="MultiLine" Height="80px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                Font-Size="8pt" CssClass="textbox"></asp:TextBox>
                                                <asp:ImageButton ID="IMbCal_Present" runat="server" ImageUrl="~/icons/icon_carlendar.gif"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">&nbsp;</td>
                                            <td>
                                                <asp:Calendar ID="cal_present" runat="server" BackColor="White"
                                                    BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest"
                                                    Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px"
                                                    Width="200px" Visible="False">
                                                    <DayHeaderStyle BackColor="#CCCCCC" Font-Bold="True" Font-Size="7pt"/>
                    ...
                    <td colspan="3">
                        <table>
                            ...
                            <tr>
                                ...
                                <td align="left" width="50%">
                                    &nbsp;<asp:TextBox ID="txtTitle_Next" runat="server" Width="171px" visible="false"
                                        Font-Size="8pt" CssClass="textbox"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" width="50%">
                                    <asp:TextBox ID="txtDetails_Next" runat="server" Width="300px" visible="false"
                                        Font-Size="8pt" CssClass="textbox" TextMode="MultiLine" Height="80px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                Font-Size="8pt" CssClass="textbox"></asp:TextBox>
                                                <asp:ImageButton ID="IMbCal_Next" runat="server" ImageUrl="~/icons/icon_carlendar.gif"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">&nbsp;</td>
                                            <td>
                                                <asp:Calendar ID="cal_next" runat="server" BackColor="White"
                                                    BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest"
                                                    Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px"
                                                    Width="200px" Visible="False">
                                                    <DayHeaderStyle BackColor="#CCCCCC" Font-Bold="True" Font-Size="7pt"/>
                            ...
                            <tr>
                                ...
                                <td align="left" width="50%">
                                    <asp:DropDownList ID="ddlAction_Next" runat="server" AutoPostBack="true" 
                                        CssClass="DDSelect" Enabled="True" AppendDataBoundItems="true">
                                        <asp:ListItem Value="0">[--Please Select--]</asp:ListItem>
                                        <asp:ListItem Value="1">Completed</asp:ListItem>
                                        <asp:ListItem Value="2">In progress</asp:ListItem>
                                                                ...
                                                                <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" 
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Type" SortExpression="startTime">
                                                                            <EditItemTemplate>
                                                                                <asp:Textbox ID="txtType" runat="server" Text='<%# Bind("startTime") %>' ></asp:Textbox>
                                                                            </EditItemTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblType" runat="server" Text='<%# Bind("startTime") %>' Width="250px"></asp:Label>
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Title" SortExpression="startTime">
                                                                            <EditItemTemplate>
                                                                                <asp:Textbox ID="txtTitle" runat="server" Text='<%# Bind("startTime") %>' ></asp:Textbox>
                                                                            </EditItemTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblTitle" runat="server" Text='<%# Bind("startTime") %>' Width="250px"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle Width="200px" />
                                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Details" SortExpression="startTime">
                                                                            <EditItemTemplate>
                                                                                <asp:Textbox ID="txtDetails" runat="server" Text='<%# Bind("startTime") %>' ></asp:Textbox>
                                                                            </EditItemTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblDetails" runat="server" Text='<%# Bind("startTime") %>' Width="250px"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle Width="200px" />
                                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Person" SortExpression="stulevel">
                                                                            <EditItemTemplate>
                                                                                <asp:Textbox ID="txtPerson" runat="server" Text='<%# Bind("endTime") %>' ></asp:Textbox>
                                                                            </EditItemTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblPerson" runat="server" Text='<%# Bind("endTime") %>' Width="250px"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle Width="200px" />
                                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Date" SortExpression="stulevel">
                                                                            <EditItemTemplate>
                                                                                <asp:Textbox ID="txtDate" runat="server" Text='<%# Bind("location") %>' ></asp:Textbox>
                                                                            </EditItemTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblDate" runat="server" Text='<%# Bind("location") %>' Width="250px"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle Width="200px" />
                                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Status" SortExpression="stulevel">
                                                                            <EditItemTemplate>
                                                                                <asp:Textbox ID="txtStatus" runat="server" Text='<%# Bind("location") %>' ></asp:Textbox>
                                                                            </EditItemTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("location") %>' Width="250px"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle Width="200px" />
                                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                                        </asp:TemplateField>
